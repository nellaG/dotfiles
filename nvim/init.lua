...
require'nvim-treesitter.configs'.setup {
  ...
  ensure_installed = { "lua", "typescript", "yaml", "toml", "tmux", "terraform", "python", "json",
  "json5", "html", "gomod", "go", "goctl", "dockerfile", "csv", "bash", "fish", "vim",
  "vimdoc", "query", "markdown", "markdown_inline",
  "git_config", "git_rebase", "gitattributes", "gitcommit", "gitignore", "nginx",
  "requirements",
  },
