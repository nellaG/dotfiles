# Generated by Powerlevel10k configuration wizard on 2020-08-29 at 20:42 KST.
...
# right frame, darkest-ornaments, sparse, few icons, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_SHORTEN_LENGTH=4
