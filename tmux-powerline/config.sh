...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/wf/znv653_s5glgqjcnqdrsw3nm0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/gallen/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/gallen/.mailcheckrc"
# }
